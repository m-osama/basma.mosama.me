        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ul class="list-inline" style="margin-bottom : -10px;">
              <li><p>feel free to ask me about anything you need to know about foods</p></li>
              <li><p class="footerar" dir="rtl" lang="ar">
          <!-- arabic start here -->
          خليكوا على رحتكوا فى أسألتكم عن اى حاجه متعلقه بالمطبخ وأنا هجاوب على كل الأسأله
          <!-- arabic end here -->
              </p></li>
            </ul>
            </center>
              ...
              <ul class="list-inline">
                ...
                <li><a href="http://spatula.me"><i class="fa fa-wordpress"></i> Spatula</a></li>
                <li><a href="#"><i class="fa fa-facebook-square"></i> Facebook</a></li>
                <li><a href="https://twitter.com/BasmaYassin_"><i class="fa fa-twitter"></i> Twitter</a></li>
                <li><a href="https://soundcloud.com/basma_mosama"><i class="fa fa-soundcloud"></i> SoundCloud</a></li>
                <li><a href="#"><i class="fa fa-youtube-play"></i> youtube</a></li>
              </ul>

              <ul class="list-inline" style="margin-bottom : 25px;">
                        <li>Designed and developed by <a href="http://mosama.me" rel="nofollow"><i class="fa fa-code"></i>&nbsp;mosama</a>. Contact him at</li>
                        <li><a href="http://fb.com/mohammedosamaahmed" class="tip" data-toggle="tooltip" data-placement="bottom" title="Facebook" data-original-title="Tooltip on bottom"><i class="fa fa-facebook-square" ></i></a></li>
